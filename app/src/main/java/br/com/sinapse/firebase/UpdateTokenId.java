...
public class UpdateTokenId {

    public static void updateTokenUser(boolean login){

        String tokenId = login ? FirebaseInstanceId.getInstance().getToken() : "logoff";
        JSONObject postData = new JSONObject();
        try {
            postData.put("tokenId",tokenId);
            postData.put("userId", MainActivity.userLogado.getId());
            SendDeviceDetails t = new SendDeviceDetails();
            t.execute(Config.ip_servidor+"/updateTokenUser.php", postData.toString());
